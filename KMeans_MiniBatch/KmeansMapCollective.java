...
public class KmeansMapCollective  extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		...
		int miniBatchSize = Integer.parseInt(args[2]);
		...
		launch(numOfDataPoints, numCentroids, miniBatchSize, sizeOfVector, numMapTasks, numIteration, workDir, localDir, operation);
		System.out.println("HarpKmeans Completed"); 
		return 0;
	}
	void launch(int numOfDataPoints, int numCentroids, int miniBatchSize, int sizeOfVector, int numMapTasks, int numIteration, String workDir, String localDir, String operation)
		...
		runKMeans(numOfDataPoints,numCentroids, miniBatchSize, sizeOfVector, numIteration,
	...
	private void runKMeans(int numOfDataPoints, int numCentroids, int miniBatchSize, int vectorSize, int numIterations, 
		...
		do {
			...
			Job kmeansJob = configureKMeansJob(numOfDataPoints, numCentroids, miniBatchSize, vectorSize, numMapTasks,
	...
	private Job configureKMeansJob(int numOfDataPoints, int numCentroids, int miniBatchSize, int vectorSize, 
		...
		jobConfig.setInt(KMeansConstants.MINI_BATCH_SIZE, miniBatchSize);
